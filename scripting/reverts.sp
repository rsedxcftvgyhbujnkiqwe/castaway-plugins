...
public void OnPluginStart() {
	...
	ItemDefine("B.A.S.E. Jumper", "basejump", "Reverted to pre-toughbreak, can redeploy, more air control, float mid-air when on fire while deployed", CLASSFLAG_SOLDIER | CLASSFLAG_DEMOMAN);
